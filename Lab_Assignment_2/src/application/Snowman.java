...
public class Snowman extends Application {
	...
	public void start(Stage primaryStage) {
		...
		Circle bottomButton = new Circle(80, 145, 6);
		...
		Group snowman = new Group(base, middle, head, leftEye, rightEye, mouth, topButton, middleButton, bottomButton,
		...
		Text name = new Text(20, 20, "Jay Manhire");
